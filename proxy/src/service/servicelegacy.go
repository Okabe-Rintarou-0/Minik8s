...
//		return err
//	}
//	if exist, err := sm.tab.Exists("nat", constant.PreRouting, "-j", constant.KubeServices); err != nil {
//		return err
//	} else if !exist {
//		if err = sm.tab.Insert("nat", constant.PreRouting, 1, "-j", constant.KubeServices); err != nil {
//			return err
//		}
//	}
//	if exist, err := sm.tab.Exists("nat", constant.Output, "-j", constant.KubeServices); err != nil {
//		return err
//	} else if !exist {
//		if err = sm.tab.Insert("nat", constant.Output, 1, "-j", constant.KubeServices); err != nil {
//			return err
//		}
//	}
//	return nil
